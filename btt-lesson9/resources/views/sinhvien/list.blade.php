    ...
    <section class="container my-3">
        <div class="card">
                        ...
                        @foreach ($bttSinhViens as $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="/sinhvien/delete/{{ $item->MaSV }}" class="btn btn-danger" onclick="return confirm('Bạn muốn xóa sinh viên này không? Mã: ' + {{ $item->MaSV }});">Xóa</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="card-footer">
                <h3>Tổng số: {{ $bttSinhViens->count() }} sinh viên</h3>
